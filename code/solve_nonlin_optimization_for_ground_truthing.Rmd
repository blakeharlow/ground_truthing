...
compute_residuals(X_guess_trunc_scaled, good_sightings_scaled, y_measured)
...
y_measured %>% matrix(ncol = 3, byrow = TRUE)
...
ggplot() +
  geom_point(data = X_guess_tbl, aes(x,y), color = "red") +
